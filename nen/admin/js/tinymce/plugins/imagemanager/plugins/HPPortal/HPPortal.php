...
class Moxiecode_HPPortalPlugin extends Moxiecode_ManagerPlugin {
	/**
	 ...
	 */
        function onAuthenticate(&$man) {
            ...
            if (isset($_SESSION['HPportal']) && isset($_SESSION['HPportal']['currentUserId']) && is_numeric($_SESSION['HPportal']['currentUserId'])) {
                $_SESSION['isLoggedIn'] = true;
                $_SESSION['user'] = $_SESSION['HPportal']['currentUserId'];
	...
	function onBeforeFileAction(&$man, $action, $file1, $file2) {
		/*
                ...
                $config['filesystem.rootpath'] = 'files/'.$_SESSION['HPportal']['currentUserId'];
		$config['filesystem.path'] = $config['filesystem.path'].'/'.$_SESSION['HPportal']['currentUserId'];
                 *
                 */
		return true;
	}
...
$res = $man->registerPlugin("HPPortal", new Moxiecode_HPPortalPlugin());
