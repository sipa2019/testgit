<?php
	...
	$mcImageManagerConfig['general.tools'] = "upload,refresh,addfavorite,removefavorite,insert,delete,edit,preview"; // "filemanager" button if you have "filemanager.urlprefix" configured.
	...
	$mcImageManagerConfig['general.plugins'] = "HPPortal,HPShop"; // comma seperated
	...
	$mcImageManagerConfig['filesystem.path'] = '';//'files/'.$_SESSION['HPportal']['currentUserId']; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '/js/tinymce/plugins/user_image/'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['filesystem.directory_templates'] = '${rootpath}/templates/177';
	$mcImageManagerConfig['filesystem.force_directory_template'] = true;
	...
	$mcImageManagerConfig['authenticator.login_page'] = "portal_session_auth.php";
