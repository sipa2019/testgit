...
require_once SITE_PATH . 'form'. DIRSEP .'News.php';

Class Controller_News Extends AdminController_Base {

    protected $_controller = 'news';
    protected $_activeTableClass = "NewsClass";
	protected $_form = 'NewsForm';	
