...
require_once SITE_PATH . 'form'. DIRSEP .'Galleries.php';

Class Controller_Galleries Extends AdminController_Base {

    protected $_controller = 'Galleries';
    protected $_activeTableClass = "GalleriesClass";
	protected $_form = 'GalleriesForm';	
...
//var_dump( $result['records']);
		$this->registry['layout']->sets(array(
			'titleMenu' => $this->translate->translate('GalleryAlbums'),
